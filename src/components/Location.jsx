...
export default function Location() {
  ...
  return (
    <section id="visitanos" className="relative border-t-2 border-bone-50/10 bg-ink-900/40">
      <div className="mx-auto max-w-6xl px-6 py-24">
        <Reveal className="mb-14 flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <span className="font-mono text-xs font-bold text-copper-400">04</span>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Reveal>
            <div className="group relative flex h-full flex-col gap-4 border-2 border-bone-50/10 bg-ink-950/50 p-7 transition-colors hover:border-copper-400/50">
              ...
              <a
                ...
                onClick={() => track('whatsapp_click', { section: 'mapa' })}
          ...
          <Reveal delay={0.08}>
            <div className="group relative flex h-full flex-col gap-4 border-2 border-bone-50/10 bg-ink-950/50 p-7 transition-colors hover:border-copper-400/50">
              ...
              <ul className="flex flex-col gap-2">
                {hours.map((h) => (
                  <li key={h.day} className="flex items-center justify-between border-b border-dashed border-bone-50/10 pb-2 last:border-0 last:pb-0">
          ...
          <Reveal delay={0.16}>
            <div className="group relative flex h-full flex-col gap-4 border-2 border-bone-50/10 bg-ink-950/50 p-7 transition-colors hover:border-copper-400/50">
              ...
              <div className="flex flex-col gap-3 text-sm">
                ...
                >
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center border-2 border-bone-50/15">
                    <InstagramIcon className="h-3.5 w-3.5 text-copper-400" />
                  </span>
                  @{BUSINESS.instagram}
                </a>
              </div>
